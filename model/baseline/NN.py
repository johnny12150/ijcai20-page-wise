...
train_history = model.fit_generator(embedding_loader(emb_2017, dblp_top50_conf.shape[0], batch), epochs=1, steps_per_epoch=dblp_top50_conf.shape[0] / batch, verbose=1)
